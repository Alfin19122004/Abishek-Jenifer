...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCountdown() {
        ...
        if (difference < 0) {
            // Target date passed
            document.getElementById('timer').innerHTML = "<div class='countdown-tagline white-text' style='font-size: 1.5rem;'>Happy Wedding Day! B. Abishek & K. Kamali Jenifer!</div>";
